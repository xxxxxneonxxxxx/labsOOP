...
{
    /// <summary>Вкладка для работы с покупателями.</summary>
    public partial class CustomersTab : UserControl
    {
        /// <summary>Коллекция.</summary>
        private ObservableCollection<Customer>? _customers;

        /// <summary>Текущий выбранный покупатель.</summary>
        ...
        /// <summary>
        /// Внешняя коллекция покупателей
        /// Должна быть установлена до взаимодействия с вкладкой.
        /// </summary>
        public ObservableCollection<Customer> Customers
        {
            get => _customers ?? throw new InvalidOperationException(
                "Коллекция покупателей не установлена. " +
                "Назначьте CustomersTab.Customers = store.Customers перед использованием.");
            set
            {
        ...
        /// <summary>Загрузка данных покупателя в форму.</summary>
        ...
        /// <summary>Добавление нового покупателя.</summary>
        ...
        /// <summary>Удаление выбранного покупателя.</summary>
        ...
        /// <summary>Сохранение данных выбранного покупателя.</summary>
